...
if __name__ == "__main__":
    ...
    for model in models:
        evaluate_model(
            ...
            system_prompt,
            test_set["tests"],
            f"model_selection/models/meal_conversion/{model}_meal_conversion_test_results.json",
        )

    compare_models(
        models,
        [f"model_selection/models/meal_conversion/{model}_meal_conversion_test_results.json" for model in models],
        "model_selection/models/meal_conversion/model_comparison.txt",
